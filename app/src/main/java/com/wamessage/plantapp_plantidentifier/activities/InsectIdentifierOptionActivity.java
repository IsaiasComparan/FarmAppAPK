...
public class InsectIdentifierOptionActivity extends AppSuperBase {
    ...
    public void NativeShow(final FrameLayout frameLayout) {
        ...
        builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
            ...
            public void onNativeAdLoaded(NativeAd nativeAd) {
                ...
                if (InsectIdentifierOptionActivity.this.mobNativeView != null) {
                    InsectIdentifierOptionActivity.this.mobNativeView.destroy();
                }
                InsectIdentifierOptionActivity.this.mobNativeView = nativeAd;
    ...
    public void InterstitialLoad() {
        ...
        InterstitialAd.load(getApplicationContext(), getString(R.string.AdMob_Interstitial), adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                InsectIdentifierOptionActivity.this.mMobInterstitialAds = interstitialAd;
    ...
    private void ShowFunUAds() {
        if (this.mMobInterstitialAds != null) {
            this.mMobInterstitialAds.show(InsectIdentifierOptionActivity.this);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insect_identifier_option);
        initView();
        NativeLoad();
        InterstitialLoad();
        setEvents();
    ...
    private void initView() {
        ...
        this.cardInsect = (CardView) findViewById(R.id.cardInsect);
    ...
    private void setEvents() {
        this.toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                InsectIdentifierOptionActivity.this.m909x40198943(view);
            }
        });
        this.cardInsect.setOnClickListener(new View.OnClickListener() {
            @Override 
            public final void onClick(View view) {
                InsectIdentifierOptionActivity.this.m910x7257044(view);
                ShowFunUAds();
            }
        });
        this.cardHistory.setOnClickListener(new View.OnClickListener() {
            @Override 
            public final void onClick(View view) {
                InsectIdentifierOptionActivity.this.m911xce315745(view);
                ShowFunUAds();
            }
        });
    }
    ...
    public  void m909x40198943(View view) {
        finish();
    }


    public  void m910x7257044(View view) {
        startActivityForResult(new Intent(this, InsectRecognitionActivity.class), GO_HOME);
    }


    public  void m911xce315745(View view) {
        startActivityForResult(new Intent(this, InsectIdentifierHistoryActivity.class), GO_HOME);
    }
