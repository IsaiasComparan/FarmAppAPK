...
public class InsectAdapter extends RecyclerView.Adapter<InsectAdapter.PlantViewHolder> {
    private List<Insect> insects;

    public InsectAdapter(List<Insect> insects) {
        this.insects = insects.subList(1, insects.size());
    }
